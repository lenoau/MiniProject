...
export default function Main() {
  ...
  useEffect(() => {
      const fetchWebtoons = async () => {
          ...
          const Url = `provider=KAKAO_PAGE&page=1&perPage=100&isFree=true&updateDay=${currentDay}`;
          const Url2 = `provider=KAKAO_PAGE&page=2&perPage=100&isFree=true&updateDay=${currentDay}`;
  ...
  return (
    <div className='items-center justify-center w-[1280px] mx-auto'>
      ...
      <div className='font-bold w-[1280px] mx-auto mb-10 mt-5'>
          <Link to='/day/KakaoPageMain/MON' className='mr-5'>월요웹툰</Link>
          <Link to='/day/KakaoPageMain/TUE' className='mr-5'>화요웹툰</Link>
          <Link to='/day/KakaoPageMain/WED' className='mr-5'>수요웹툰</Link>
          <Link to='/day/KakaoPageMain/THU' className='mr-5'>목요웹툰</Link>
          <Link to='/day/KakaoPageMain/FRI' className='mr-5'>금요웹툰</Link>
          <Link to='/day/KakaoPageMain/SAT' className='mr-5'>토요웹툰</Link>
          <Link to='/day/KakaoPageMain/SUN' className='mr-5'>일요웹툰</Link>
      </div>
