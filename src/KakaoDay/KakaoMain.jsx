...
export default function Main() {
  ...
  useEffect(() => {
      const fetchWebtoons = async () => {
          ...
          const Url = `provider=KAKAO&page=1&perPage=100&isFree=true&updateDay=${currentDay}`;
          const Url2 = `provider=KAKAO&page=2&perPage=100&isFree=true&updateDay=${currentDay}`;
